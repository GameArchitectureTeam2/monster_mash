...
#ifndef IK_VTABLE_SOLVER_ONE_BONE_H
#define IK_VTABLE_SOLVER_ONE_BONE_H
...
IK_PRIVATE_API uintptr_t ik_solver_ONE_BONE_type_size(void);
IK_PRIVATE_API ikret_t ik_solver_ONE_BONE_construct(struct ik_solver_t* solver);
IK_PRIVATE_API void ik_solver_ONE_BONE_destruct(struct ik_solver_t* solver);
IK_PRIVATE_API ikret_t ik_solver_ONE_BONE_solve(struct ik_solver_t* solver);
static inline ikret_t ik_solver_ONE_BONE_harness_solve_return_value(ikret_t, ikret_t);
#define IK_SOLVER_ONE_BONE_IMPL \
    ik_solver_ONE_BONE_type_size, \
    ik_solver_base_create, \
    ik_solver_base_destroy, \
    ik_solver_ONE_BONE_harness_construct, \
    ik_solver_ONE_BONE_harness_destruct, \
    ik_solver_base_rebuild, \
    ik_solver_base_update_distances, \
    ik_solver_ONE_BONE_harness_solve, \
...
static inline ikret_t ik_solver_ONE_BONE_harness_construct(struct ik_solver_t* solver)
{
    ikret_t result;
    if ((result = ik_solver_base_construct(solver)) != IK_OK) goto solver_base_failed;
    if ((result = ik_solver_ONE_BONE_construct(solver)) != IK_OK) goto solver_ONE_BONE_failed;
    return IK_OK;
    solver_ONE_BONE_failed : ik_solver_base_destruct(solver);
    solver_base_failed : return result;
}
static inline void ik_solver_ONE_BONE_harness_destruct(struct ik_solver_t* solver)
{
    ik_solver_ONE_BONE_destruct(solver);
    ik_solver_base_destruct(solver);
}
static inline ikret_t ik_solver_ONE_BONE_harness_solve(struct ik_solver_t* solver)
{
    ikret_t a = ik_solver_base_solve(solver);
    ikret_t b = ik_solver_ONE_BONE_solve(solver);
    return ik_solver_ONE_BONE_harness_solve_return_value(a, b);
}
...
#define IK_EFFECTOR_ONE_BONE_IMPL \
...
#define IK_CONSTRAINT_ONE_BONE_IMPL \
...
#endif /* IK_VTABLE_SOLVER_ONE_BONE_H */
